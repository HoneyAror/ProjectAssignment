package com.example.bootcamp.security;
        ...
        import com.example.bootcamp.exceptions.AccountLockedException;
        import com.example.bootcamp.exceptions.UserDeactivateException;
        import com.example.bootcamp.repos.UserRepository;
        import com.example.bootcamp.services.EmailService;
        ...
        if (user != null) {
            if (user.isLocked()) {
                throw new AccountLockedException(
                        "Your Account is locked.Please contact with support team!");
            }
            if (!user.isActive()) {
